...
import gateway.hitrontech.com.encryption.manager.SharePreManager;
...
public class MainActivity extends AppCompatActivity implements OnClickListener{
    ...
    private void initView() {
        ...
        mArrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_selectable_list_item, mPasswordList);
    ...
    private void encryptionData() {
        String encryptionStr = EncryptionManager.getInstance().base64EncoderByAppId(getString(R.string.applicationId), "JWT", mPlainText.getText().toString());
        Log.w("JWT", "encryptionStr : " + encryptionStr);
        mCipheText.setText(encryptionStr);

    }

    private void decryptionData() {
        String decryptStr = EncryptionManager.getInstance().base64DecoderByAppId(getString(R.string.applicationId), "JWT", mCipheText.getText().toString());
        Log.w("JWT", " decryptStr : " + decryptStr);
    ...
    private String getSecretKey() {
        ...
        String secretKey = new StringBuffer().append(getString(R.string.applicationId))/*.append(getString(R.string.versionCode))*/.append(mPassword).toString();
        return secretKey;
    }
}
